class LookupsController < ApplicationController
  ...
  def process_excel_file(input_path, selected_fields)
    ...
    sheet.each_with_index do |row, i|
      ...
      # if selected_fields.include?("raison_sociale")
      #   row_data << (api_data["nom_raison_sociale"] || "Non trouvée")
      # end
  ...
  #     if selected_fields.include?("nature_juridique")
  #       row_data << (api_data["categorie_entreprise"] || "Non trouvée")
  #     end

  #     if selected_fields.include?("capital_social")
  #       row_data << (api_data["capital_social"] || "Non trouvé") # ⚠️ ce champ n'existe pas dans l'exemple, on garde pour futur
  #     end
